...
using MimyMart.Application.InventoryProducts.Commands.Create;
using MimyMart.Application.InventoryProducts.Commands.UpdateInventoryProductBarcodeCounter;
using MimyMart.Application.InventoryProducts.Queries.GetBarcodeCounter;
