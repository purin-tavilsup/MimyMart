...
using MimyMart.Application.InventoryProducts.Queries.GetByBrandKeyword;
using MimyMart.Application.InventoryProducts.Queries.GetByCategoryId;
using MimyMart.Application.InventoryProducts.Queries.GetByDescriptionKeyword;
...
using MimyMart.Windows.Forms.Events;
using MimyMart.Windows.Forms.Extensions;
using Prism.Events;
