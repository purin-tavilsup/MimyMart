...
using MimyMart.Application.UserCredentials.Queries.GetUserCredentialById;
using MimyMart.Application.Users;
using MimyMart.Application.Users.Commands.DeleteUser;
using MimyMart.Application.Users.Queries.GetUserById;
using MimyMart.Application.Users.Queries.GetUsers;
using MimyMart.Domain.Events;
using MimyMart.Windows.Forms.Properties;
using Prism.Events;
using UserRoleEnum = MimyMart.Application.Common.Enums.UserRole;

namespace MimyMart.Windows.Forms.UI.User;
